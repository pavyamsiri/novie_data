...
class _CorrugationResidualsDataLoader(Protocol):
    def __call__(self, file: Hdf5File) -> CorrugationResidualsData: ...
...
class CorrugationResidualsData:
    ...
    @staticmethod
    def load(path: Path) -> CorrugationResidualsData:
...
def load_v2(file: Hdf5File) -> CorrugationResidualsData:
    cls = CorrugationResidualsData
...
def load_v3(file: Hdf5File) -> CorrugationResidualsData:
    cls = CorrugationResidualsData
    metric_name = get_str_attr_from_hdf5(file, "metric_name")
    name = get_str_attr_from_hdf5(file, "name")
